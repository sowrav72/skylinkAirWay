...
export const putStaffProfile = (body) => client.put('/api/staff/profile', body)
export const putStaffPreferences = (body) => client.put('/api/staff/preferences', body)
export const getStaffDashboard = () => client.get('/api/staff/dashboard')
export const getStaffFlights = () => client.get('/api/staff/flights')
export const createStaffFlight = (body) => client.post('/api/staff/flights', body)
export const updateStaffFlight = (id, body) => client.put(`/api/staff/flights/${id}`, body)
export const cancelStaffFlight = (id) => client.delete(`/api/staff/flights/${id}`)
...
export const getStaffBookings = (params) => client.get('/api/staff/bookings', { params })
export const patchStaffBookingStatus = (id, body) => client.patch(`/api/staff/bookings/${id}/status`, body)
export const getStaffRoster = () => client.get('/api/staff/crew/roster')
export const requestCrewSwap = (body) => client.post('/api/staff/crew/swaps', body)
export const getStaffReports = () => client.get('/api/staff/reports/analytics')
export const getStaffInventory = () => client.get('/api/staff/inventory')
export const createStaffInventory = (body) => client.post('/api/staff/inventory', body)
export const updateStaffInventory = (id, body) => client.patch(`/api/staff/inventory/${id}`, body)
